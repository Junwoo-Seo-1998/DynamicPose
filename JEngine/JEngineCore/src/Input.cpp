...
void Input::GLFWMousePositionCallback(GLFWwindow* window, double xposIn, double yposIn)
{
...
void Input::GLFWMouseScrollCallback(GLFWwindow* window, double, double yOffset)
{
